...
var generateFortuneCookie = function() {
    ...
    // TODO: Grab the paragraph with the ID `fortune-cookie-text` to be able to insert text into that element.
      var fortuneCookieText = document.getElementById('fortune-cookie-text');
    // TODO: Update the Previous Fortunes list with the current `innerHTML` value of `#fortune-cookie-text`. Follow these steps:
    // 1. Create a new `li` element with the `document.createElement()` method.
     ...
     // 3. Select the `#previous-fortunes-container` container and us `appendChild()` to append the new `li` element you above.    
    ...
    // `innerText` of the `#fortune-cookie-text` element.
        ...
        fortuneCookieText.innerHTML = random;          
